...
export const FXA_PROFILE_SERVER = 'https://latest.dev.lcip.org/profile/v1';
export const FXA_CONTENT_SERVER = 'https://latest.dev.lcip.org';
export const FXA_OAUTH_SERVER = 'https://oauth-latest.dev.lcip.org/v1';
